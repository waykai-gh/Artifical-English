...
export const envSchema = z.object({
  ...
  ALLOWED_USER_IDS: telegramIds,
  ADMIN_TELEGRAM_IDS: telegramIds,
  ALERTS_ENABLED: z.enum(['true', 'false']).default('true'),
  ALERT_TRANSIENT_FAILURE_THRESHOLD: integer(3, 2, 20),
  ALERT_COOLDOWN_MINUTES: integer(30, 5, 1440),
  ...
  CLOUDFLARE_OUTPUT_NEURONS_PER_MILLION: integer(30475, 0, 1000000000),
  OPENROUTER_DAILY_REQUEST_BUDGET: integer(50, 0, 1000000000),
